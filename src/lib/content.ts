...
export const projectCards = {
  en: [
    ...
    },
    {
      ...
      summary: "Full technical SEO audit and remediation: fixed hreflang for Chinese-language indexing, added structured data, restructured i18n, and shipped a sitemap to Google Search Console.",
      stats: [
  ...
  zh: [
    ...
    },
    {
      ...
      summary: "完整技术 SEO 审计与修复：修复中文页面的 hreflang 索引问题、新增结构化数据、重构国际化目录，并向 Google Search Console 提交站点地图。",
      stats: [
...
export const p7 = {
  en: {
    tag: "Project 7 · June 2026",
    title: "RedBridge Website V3 — Technical SEO Audit & Restructure",
    ...
    impact: [
      ...
      {
        label: "Marketing",
        text: "Fixed hreflang and canonical errors directly improve organic visibility for RedBridge's bilingual EN/ZH audience. The Chinese-language pages are now properly indexed and eligible to rank in zh-CN Google Search — opening a channel to RedBridge's core Mandarin-speaking skilled migrant audience without any additional ad spend.",
      },
      {
        label: "Revenue",
        text: "BreadcrumbList and Organization structured data make RedBridge's service pages eligible for enhanced SERP features (FAQ accordions, knowledge panel), increasing click-through rate at zero marginal cost. The sitemap submission to Google Search Console accelerates re-crawl of every fixed page, shortening the time-to-impact across the whole audit.",
      },
    ],
    tableRows: [
      ...
      { field: "Scope", fieldZh: "范围", value: "Metadata architecture, i18n/hreflang, URL structure, structured data, sitemap & robots config", valueZh: "元数据架构、国际化/hreflang、URL 结构、结构化数据、站点地图与 robots 配置" },
      ...
      { field: "Key Fixes", fieldZh: "关键修复", value: "Hreflang, duplicate page titles, sitemap.xml, robots.ts, JSON-LD (BreadcrumbList & Organization), MARN/ABN constant, messages/ restructure", valueZh: "hreflang、重复页面标题、sitemap.xml、robots.ts、JSON-LD（BreadcrumbList 与 Organization）、MARN/ABN 常量、messages/ 重构" },
  ...
  zh: {
    tag: "项目 7 · 2026年6月",
    title: "RedBridge 网站 V3 — 技术 SEO 审计与重构",
    ...
    impact: [
      ...
      {
        label: "营销",
        text: "修复的 hreflang 和规范链接错误直接提升 RedBridge 中英双语受众的自然搜索可见度。中文页面现已被正确索引，并具备在 zh-CN Google 搜索中排名的资格 — 首次为 RedBridge 的核心华语技术移民受众打开自然流量渠道，无需额外广告投入。",
      },
      {
        label: "收入",
        text: "BreadcrumbList 和 Organization 结构化数据使 RedBridge 的服务页面具备增强版搜索结果展示资格（FAQ 折叠面板、知识图谱），以零边际成本提升点击率。向 Google Search Console 提交的站点地图加速了所有修复页面的重新抓取，缩短了整体审计成效的显现时间。",
      },
    ],
    tableRows: [
      { field: "Project Name", fieldZh: "项目名称", value: "RedBridge Website V3 — Technical SEO Audit, Restructure & Deployment", valueZh: "RedBridge 网站 V3 — 技术 SEO 审计、重构与部署" },
