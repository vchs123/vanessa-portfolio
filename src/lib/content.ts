...
export const p7 = {
  en: {
    ...
    tableRows: [
      ...
      { field: "Period", fieldZh: "周期", value: "Mar 6 – Jun 2026 (5 phases)", valueZh: "2026年3月6日–6月（5个阶段）" },
      { field: "Company", fieldZh: "公司", value: "Good Mood Studio · Siddeley Group — supporting RedBridge Consulting", valueZh: "Good Mood Studio · Siddeley Group — 协力支持 RedBridge Consulting" },
      ...
      { field: "Stack", fieldZh: "技术栈", value: "Next.js + next-intl · Tailwind CSS · Cloudflare Workers via OpenNext · GitHub Actions CI/CD · Google Search Console", valueZh: "Next.js + next-intl · Tailwind CSS · 通过 OpenNext 部署至 Cloudflare Workers · GitHub Actions CI/CD · Google Search Console" },
      { field: "Phase 1 Scope", fieldZh: "第一阶段范围", value: "V3 redevelopment from scratch — architecture, design system, hub-and-spoke SEO, full EN/ZH i18n", valueZh: "从零开始的 V3 重构 — 架构、设计系统、轮辐式 SEO 架构、完整中英国际化" },
    ...
    phases: [
      {
        ...
        outcomes: [
          "Solo end-to-end redevelopment of the RedBridge Consulting website to V3 — 18 bilingual EN/ZH routes and 178 reusable components built from scratch on Next.js + next-intl",
      ...
      },
      {
        ...
        outcomes: [
          ...
          "Designed and shipped a CI/CD pipeline via GitHub Actions that automatically builds and deploys to Cloudflare Workers on every push to main — eliminating the class of manual deployment errors that caused the above incident",
          "The automated pipeline means every future code change is deployed consistently and verifiably, with no manual steps between a merged PR and a live production update",
        ],
      },
    ],
    highlights: [
      "Sole technical architect, developer & SEO implementer across all 5 phases — Mar to Jun 2026, 283+ commits",
      "Phase 1: solo redevelopment to V3 — 18 bilingual routes, 178 components, full EN/ZH i18n via next-intl, built from scratch",
      ...
      "Phase 6: designed and shipped a GitHub Actions CI/CD pipeline — every push to main now automatically builds and deploys to Cloudflare Workers, eliminating manual deployment errors",
    ],
    statsGrid: [
      { num: "283+", label: "Commits" },
      { num: "18", label: "Routes" },
    ...
    phases: [
      {
        ...
        outcomes: [
          "独立完成 RedBridge Consulting 网站从零到 V3 的端到端重构 — 基于 Next.js + next-intl 构建 18 个中英双语路由及 178 个可复用组件",
      ...
      },
      {
        ...
        outcomes: [
          ...
          "设计并交付了基于 GitHub Actions 的 CI/CD 流水线，每次推送至 main 分支时自动构建并部署至 Cloudflare Workers — 从根本上消除了导致上述事故的手动部署错误类型",
          "自动化流水线确保每次代码变更都能一致、可验证地完成部署，合并 PR 与线上生产更新之间不再需要任何手动步骤",
        ],
      },
    ],
    highlights: [
      "在全部 6 个阶段（2026年3月–6月，283+ 次提交）中担任唯一技术架构师、开发者兼 SEO 实施者 — Good Mood Studio × Siddeley Group 跨子公司协作",
      "第一阶段：独立完成 V3 重构 — 18 个双语路由、178 个组件，基于 next-intl 实现完整中英国际化，全部从零构建",
      ...
      "第六阶段：设计并交付 GitHub Actions CI/CD 流水线 — 每次推送至 main 自动构建并部署至 Cloudflare Workers，从根本上消除手动部署错误",
    ],
    statsGrid: [
      { num: "283+", label: "提交次数" },
      { num: "18", label: "路由数" },
