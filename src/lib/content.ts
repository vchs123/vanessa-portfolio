...
export const p7 = {
  en: {
    ...
    tableRows: [
      ...
      { field: "Stack", fieldZh: "技术栈", value: "Next.js + next-intl · Tailwind CSS · Cloudflare Workers via OpenNext · GitHub Actions CI/CD · Google Sheets API · Meta Conversions API · Google Search Console", valueZh: "Next.js + next-intl · Tailwind CSS · 通过 OpenNext 部署至 Cloudflare Workers · GitHub Actions CI/CD · Google Sheets API · Meta Conversions API · Google Search Console" },
      { field: "Phase 1 Scope", fieldZh: "第一阶段范围", value: "V3 redevelopment from scratch — architecture, design system, hub-and-spoke SEO, full EN/ZH i18n, multi-step booking form, Google Sheets lead capture, Meta CAPI", valueZh: "从零开始的 V3 重构 — 架构、设计系统、轮辐式 SEO 架构、完整中英国际化、多步骤预约表单、Google Sheets 线索捕获、Meta CAPI" },
      { field: "Phase 2 Scope", fieldZh: "第二阶段范围", value: "Technical debt reduction, architecture restructure, content accuracy — deleted 16 dead legacy message files, promoted v2 content to canonical paths", valueZh: "技术债削减、架构重组、内容准确性核查 — 删除 16 个废弃 messages 文件，将 v2 内容提升至规范路径" },
    ...
    phases: [
      {
        ...
        outcomes: [
          ...
          "Integrated Meta Conversions API (CAPI) for server-side ad attribution — enabling accurate tracking of leads generated from Facebook and Instagram campaigns, reducing reliance on client-side pixel data that is lost to ad blockers",
      ...
      },
      {
        ...
        outcomes: [
          ...
          "Audited and cleaned up the messages architecture: promoted v2 content files to canonical paths, deleted 16 dead legacy files, and consolidated both locale index files — reducing codebase noise and making future content updates unambiguous",
      ...
      },
      {
        ...
        outcomes: [
          ...
          "Every future code change is deployed consistently and verifiably within ~2 minutes of a push to main, with no manual steps between a merged PR and a live production update",
        ],
      },
    ],
    highlights: [
      "Sole technical architect, developer & SEO implementer across all 5 phases — Mar to Jun 2026, 283+ commits",
      ...
      "Phase 1: integrated Meta Conversions API (CAPI) for server-side ad attribution — tracks leads from Facebook/Instagram campaigns without relying on client-side pixel data",
      ...
      "Phase 2: audited and cleaned up the messages architecture — deleted 16 dead legacy files, promoted v2 content to canonical paths, and consolidated both locale index files",
      ...
      "Phase 6: designed and shipped a GitHub Actions CI/CD pipeline — every push to main builds and deploys to Cloudflare Workers globally within ~2 minutes, eliminating manual deployment errors",
    ],
    statsGrid: [
      { num: "283+", label: "Commits" },
      { num: "18", label: "Routes" },
    ...
    phases: [
      {
        ...
        outcomes: [
          ...
          "集成 Meta Conversions API（CAPI）实现服务端广告归因 — 精准追踪 Facebook 与 Instagram 广告带来的线索，不受广告拦截器影响客户端像素数据丢失的制约",
      ...
      },
      {
        ...
        outcomes: [
          ...
          "审计并清理 messages 架构：将 v2 内容文件提升至规范路径，删除 16 个废弃历史文件，合并两个语言区域索引文件 — 减少代码库噪音，使后续内容更新路径清晰明确",
      ...
      },
      {
        ...
        outcomes: [
          ...
          "每次代码变更在推送至 main 后约 2 分钟内完成一致、可验证的部署，合并 PR 与线上生产更新之间不再需要任何手动步骤",
        ],
      },
    ],
    highlights: [
      ...
      "第一阶段：集成 Meta Conversions API（CAPI）实现服务端广告归因 — 精准追踪 Facebook/Instagram 广告线索，不受广告拦截器影响",
      "第一阶段：为雇主担保通道服务板块设计轮辐式 SEO 架构，将主题权重集中于一个枢纽页面与三个子页面",
      "第二阶段：审计并清理 messages 架构 — 删除 16 个废弃历史文件，将 v2 内容提升至规范路径，合并两个语言区域索引文件",
      ...
      "第六阶段：设计并交付 GitHub Actions CI/CD 流水线 — 每次推送至 main 后约 2 分钟内全球部署至 Cloudflare Workers，从根本上消除手动部署错误",
    ],
    statsGrid: [
      { num: "283+", label: "提交次数" },
      { num: "18", label: "路由数" },
