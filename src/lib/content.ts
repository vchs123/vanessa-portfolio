...
export const p7 = {
  en: {
    tag: "Project 7 · Mar – Jun 2026",
    title: "RedBridge Website V3",
    subtitle: "Role: Head of IT · Sole technical architect, developer & SEO implementer · Cross-subsidiary, Siddeley Group · 7 phases · 24+ routes · 182+ components · 310+ commits",
    accent: "#0d9488",
    liveUrl: "https://redbridge-consulting.com.au",
    impact: [
      {
    ...
    tableRows: [
      ...
      { field: "Period", fieldZh: "周期", value: "Mar 6 – Jun 2026 (7 phases)", valueZh: "2026年3月6日–6月（7个阶段）" },
      ...
      { field: "Total Commits", fieldZh: "总提交数", value: "310+", valueZh: "310+" },
    ...
    highlights: [
      "Sole technical architect, developer & SEO implementer across all 7 phases — Mar to Jun 2026, 310+ commits",
    ...
    statsGrid: [
      { num: "310+", label: "Commits" },
      { num: "24+", label: "Routes" },
      { num: "182+", label: "Components" },
      { num: "7", label: "Phases" },
      { num: "6", label: "New pages (Phase 7)" },
  ...
  zh: {
    tag: "项目 7 · 2026年3月–6月",
    title: "RedBridge 网站 V3",
    subtitle: "职能：IT 总监 · 独立技术架构师、开发者兼 SEO 实施者 · 跨子公司，Siddeley Group · 7 个阶段 · 24+ 个路由 · 182+ 个组件 · 310+ 次提交",
    accent: "#0d9488",
    liveUrl: "https://redbridge-consulting.com.au",
    impact: [
      {
    ...
    highlights: [
      "在全部 7 个阶段（2026年3月–6月，310+ 次提交）中担任唯一技术架构师、开发者兼 SEO 实施者 — Good Mood Studio × Siddeley Group 跨子公司协作",
