...
export const projectCards = {
  en: [
    ...
    },
    {
      ...
      summary: "5-phase solo redevelopment and technical SEO overhaul: 18 bilingual routes, 178 components, hub-and-spoke SEO architecture, full technical SEO audit, and a sitemap submitted to Google Search Console.",
      stats: [
  ...
  zh: [
    ...
    },
    {
      ...
      summary: "5 阶段独立重构与技术 SEO 全面升级：18 个双语路由、178 个组件、轮辐式 SEO 架构、完整技术 SEO 审计，并向 Google Search Console 提交站点地图。",
      stats: [
        { num: "283+", label: "提交次数" },
...
export const p7 = {
  en: {
    tag: "Project 7 · Mar – Jun 2026",
    title: "RedBridge Website V3",
    subtitle: "Role: Head of IT · Sole technical architect, developer & SEO implementer · 5 phases · 18 routes · 178 components · 283+ commits",
    accent: "#0d9488",
    liveUrl: "https://redbridge.pages.dev/",
    impact: [
      {
    ...
    tableRows: [
      ...
      { field: "Company", fieldZh: "公司", value: "RedBridge Consulting (Siddeley Group)", valueZh: "RedBridge Consulting（Siddeley Group）" },
      { field: "Role", fieldZh: "职能", value: "Head of IT — Sole technical architect, developer & SEO implementer", valueZh: "IT 总监 — 独立技术架构师、开发者兼 SEO 实施者" },
      ...
      { field: "Stack", fieldZh: "技术栈", value: "Next.js + next-intl · Tailwind CSS · Cloudflare Workers via OpenNext · Google Search Console", valueZh: "Next.js + next-intl · Tailwind CSS · 通过 OpenNext 部署至 Cloudflare Workers · Google Search Console" },
      ...
      { field: "Phase 2 Scope", fieldZh: "第二阶段范围", value: "Technical debt reduction, architecture restructure, content accuracy", valueZh: "技术债削减、架构重组、内容准确性核查" },
      ...
      { field: "Phase 5 Scope", fieldZh: "第五阶段范围", value: "FAQPage & LocalBusiness schema, sitemap submitted to GSC, /services/ URL flattening, founder support", valueZh: "FAQPage 与 LocalBusiness 结构化数据、站点地图提交至 GSC、/services/ URL 精简、创始团队支持" },
    ...
    phases: [
      ...
      },
      {
        ...
        outcomes: [
          ...
          "Restructured the messages/ directory, removing legacy versioning artefacts (v2/, services/) inherited from earlier site iterations",
    ...
    highlights: [
      ...
      "Phase 2: restructured the messages/ directory, removing legacy v2/ and services/ versioning artefacts",
      ...
      "Phase 5: flattened /services/ URLs for the 3 Employer Pathway spoke pages and supported RedBridge's founders through GSC and Google Business Profile setup",
    ],
    statsGrid: [
      { num: "283+", label: "Commits" },
      { num: "18", label: "Routes" },
  ...
  zh: {
    tag: "项目 7 · 2026年3月–6月",
    title: "RedBridge 网站 V3",
    subtitle: "职能：IT 总监 · 独立技术架构师、开发者兼 SEO 实施者 · 5 个阶段 · 18 个路由 · 178 个组件 · 283+ 次提交",
    accent: "#0d9488",
    liveUrl: "https://redbridge.pages.dev/",
    impact: [
      {
    ...
    phases: [
      ...
      },
      {
        ...
        outcomes: [
          ...
          "重构 messages/ 目录，移除早期版本遗留的版本化产物（v2/、services/）",
    ...
    highlights: [
      ...
      "第五阶段：精简 3 个雇主担保通道子页面的 /services/ URL，并指导 RedBridge 创始团队完成 GSC 与 Google Business Profile 设置",
    ],
    statsGrid: [
      { num: "283+", label: "提交次数" },
      { num: "18", label: "路由数" },
