...
export const p7 = {
  en: {
    ...
    tableRows: [
      ...
      { field: "Period", fieldZh: "周期", value: "Mar 6 – Jun 2026 (6 phases)", valueZh: "2026年3月6日–6月（6个阶段）" },
      ...
      { field: "Total Commits", fieldZh: "总提交数", value: "283+", valueZh: "283+" },
      { field: "Routes", fieldZh: "路由数", value: "18 bilingual page routes (EN + ZH)", valueZh: "18 个双语页面路由（中 + 英）" },
      { field: "Components", fieldZh: "组件数", value: "178", valueZh: "178" },
    ...
    highlights: [
      "Sole technical architect, developer & SEO implementer across all 6 phases — Mar to Jun 2026, 283+ commits",
    ...
    statsGrid: [
      { num: "283+", label: "Commits" },
      { num: "18", label: "Routes" },
      { num: "178", label: "Components" },
      { num: "6", label: "Phases" },
      { num: "3", label: "Pages w/ BreadcrumbList & FAQPage" },
  ...
  zh: {
    ...
    highlights: [
      "在全部 6 个阶段（2026年3月–6月，283+ 次提交）中担任唯一技术架构师、开发者兼 SEO 实施者 — Good Mood Studio × Siddeley Group 跨子公司协作",
    ...
    statsGrid: [
      ...
      { num: "178", label: "组件数" },
      { num: "6", label: "阶段数" },
      { num: "3", label: "新增 BreadcrumbList 与 FAQPage 的页面" },
